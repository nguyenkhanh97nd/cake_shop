...
<div class="content-section" style="padding-bottom:120px">
    <form action="admin.php/product/postAdd" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label>Name</label>
            <input class="form-control" name="txtName" placeholder="Name Product">
        </div>
        <div class="form-group">
            <label>Price</label>
            <input class="form-control" name="numPrice" placeholder="Price Product">
        </div>
        <div class="form-group">
            <label>Slug</label>
            <input class="form-control" name="txtSlug" placeholder="Slug Product">
        </div>
        <div class="form-group">
            <label>Brief</label>
        ...
        <button type="submit" name="add_product" class="btn btn-default">Add</button>
